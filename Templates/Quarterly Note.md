...
retreat: "[[<% tp.file.title %> Personal Retreat]]"
focus_area: 
tags:
  - quarterly
---
« [[<% moment(tp.file.title, "YYYY-[Q]Q").subtract(1, "quarter").format("YYYY-[Q]Q") %>|Last quarter]] · [[Compass Dashboard]] · [[<% moment(tp.file.title, "YYYY-[Q]Q").add(1, "quarter").format("YYYY-[Q]Q") %>|Next quarter]] »

<% moment(tp.file.title, "YYYY-[Q]Q").startOf("quarter").format("MMM D") %> to <% moment(tp.file.title, "YYYY-[Q]Q").endOf("quarter").format("MMM D, YYYY") %> · Retreat: [[<% tp.file.title %> Personal Retreat]]
...
![[<% tp.file.title %> Personal Retreat#Intentions for next quarter]]
